//
//  SecondCourseViewController.swift
//  Drevmass
//
...
//    }
    ...
    private lazy var courseMainImageView: UIImageView = {
        let iv = UIImageView()
        iv.image = UIImage(named: "secondCourseIV")
    ...
    private lazy var detailInfoLabel: UILabel = {
        let label = UILabel()
        label.text = "Курс по эффективному внедрению тренажера Древмасс в ваши ежедневные занятия по укреплению спины за 21 день"
    ...
    private lazy var bonusTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Начислим 1000 бонусов за прохождение курса"
    ...
    private lazy var lessonsCollectionView: UICollectionView = {
        ...
        collectionView.register(SecondCourseCollectionViewCell.self, forCellWithReuseIdentifier: "SecondCourseCollectionViewCell")
...
extension SecondCourseViewController {
...
extension SecondCourseViewController: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension SecondCourseViewController: UIScrollViewDelegate {
