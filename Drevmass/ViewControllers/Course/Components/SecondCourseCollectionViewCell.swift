//
//  SecondCourseCollectionViewCell.swift
//  Drevmass
//
...
class SecondCourseCollectionViewCell: UICollectionViewCell {
    
    let identifier = "SecondCourseCollectionViewCell"
...
extension SecondCourseCollectionViewCell {
